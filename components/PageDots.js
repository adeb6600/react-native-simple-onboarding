...
const PageDot = ({ isLight, selected }) => (
  <View
    style={{
      ...styles.element,
      ...styles.elementDot,
      backgroundColor: isLight ? (selected ? 'rgb(255,255,255)' : 'rgba(255,255,255,0.5)') : (selected ? '#fff' : 'rgba(255, 255, 255, 0.5)'),
    }}
  />
);
...
const PageDots = ({ isLight, pages, currentPage }) => (
  <View style={styles.container}>
    ...
    <PageCheckmark style={{ color: isLight ? 'rgba(255,255,255,0.5)' : 'rgb(255, 255, 255)' }} />
  </View>
);
